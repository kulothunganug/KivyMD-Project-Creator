...
<TextFieldRound>:
    ...
    canvas.before:
        ...
        Line:
            ellipse: self.pos[0] - self.size[1] / 2, self.pos[1], \
                    self.size[1], self.size[1], 180, 360
        Line:
            ellipse: self.size[0] + self.pos[0] - self.size[1] / 2.0, \
                    self.pos[1], self.size[1], self.size[1], 360, 540
